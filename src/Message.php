...
{     public function run(string $message) 
    {
        ...
        foreach($message as $key => $currentLetter) {
            ...
            if ($this->isUpperCase($currentLetter) && $this->isLowerCase($lastLetter) && ! $this->isSpecial($currentLetter)) {
                $phrase .= "#";
            }

            if ($this->isLowerCase($currentLetter) && $this->isUpperCase($lastLetter) && ! $this->isSpecial($currentLetter)) {
                $phrase .= "#";
            }
            ...
            if ($this->isSpecial($currentLetter) && $this->isUpperCase($lastLetter)) {
                $bool = true;
            }

            $phrase .= $this->parseToNumber($currentLetter);

            if ($currentLetterNumber === $nextLetterNumber && $this->isUpperCase($currentLetter) === $this->isUpperCase($nextLetter) && ! $this->isSpecial($currentLetter)) {
                $phrase .= ' ';
            }
        }
