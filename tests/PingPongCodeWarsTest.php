...
class PingPongCodeWarsTest extends TestCase
{
    ...
    //   }
      ...
      public function testSample7()
      {
        ...
        $this->assertSame("ping", $pingPonng->run("ping-pong-ping-pong-ping-pong-ping-pong-ping-pong-ping-clak-ping-pong-ping-pong-ping-pong-tong-zoom-ping-pong-ping-doof-zoom-ping-pong-ping-pong-ping-pong-ping-pang"));
      }
}
